...
//    $url = 'http://192.168.43.162:8055/items/ticket?fields=ticket_x_session.session_id';
    ...
    curl_setopt($curl, CURLOPT_URL, "https://api-ticket.arisukarno.xyz/items/order?fields=customer_id,invoice_id.invoice_status,ticket_id.ticket_type,ticket_id.ticket_x_session.session_id&filter[invoice_id][invoice_status]=1");
